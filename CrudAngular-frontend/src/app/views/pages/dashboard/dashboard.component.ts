...
export class DashboardComponent implements OnInit {
  ...
  constructor(private calendar: NgbCalendar, private employessService: EmployeesService, private router: Router) {}
...
this.countEmployees();
  ...
  private countEmployees(){
    this.employessService.countemployees().subscribe(data => {
      this.countemp = data;
      console.log(this.countemp);
    });
  }
